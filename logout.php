...
<div class="container">
  <div class="overlay" id="overlay">
    <div class="sign-in" id="sign-in">
          <h1>Hello, Friend!</h1>
      <p>TEnter your personal details and start a journey with us</p>
      <a href="insert.php" style="text-decoration:none;"><button class="switch-button" id="slide-right-button">Sign up</button></a>
    </div>
  </div>
  <div class="form">
    ...
    <div class="sign-up" id="sign-up-info">
      ...
      <p class="small">or use your email for login:</p>
